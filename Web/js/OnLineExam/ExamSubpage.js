...
totalscore=0;
 ...
 function getSubjectData() {
          clear();
        $.ajax({
            url: BaseData.WebApiUrl + "OnlineExam/getQuestionBankList/",
            type: "get",
            data:"qidStr="+getUrlParam("questions"), 
...
function saveData(){
 ...
 splicingField();
   // var demo=document.getElementById('Patient').contentWindow;
    ...
    postData += '[{';
    postData += '"Id":1,';
    postData += '"Username":"' + $("#User").html() + '",';
    postData += '"Submitanswer":"' + str  + '",';
    postData += '"Examtime":"' + dateTimeFormatter(examTime,"yyyy-mm-dd hh:mi:ss") + '",';
    postData += '"Score":' + score + ',';
    postData += '"Totalscore":' + $("#Totalscore").html()  + ',';
    postData += '"Examtype":"在线考试",';
    postData += '"Exampaperid":' +$("#Papernumber").html() + ',';
